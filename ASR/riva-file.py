...
def main() -> None:
    args = parse_args()
    args.server= "10.9.3.239:50051"
    print('=======')
    # args.language_code="vi-VN"
    print('[INFO] args: ', args)
    if args.list_devices:
        riva.client.audio_io.list_output_devices()
        return
    print('=============')
    # print('[INFO] args: ', args.ssl_cert, args.use_ssl, args.server)
    ...
    config.config.language_code = "vi-VN"
    print('=======')
    ...
    try:
        ...
        with riva.client.AudioChunkFileIterator(
            ...
            print('[INFO] audio_chunk_iterator: ', audio_chunk_iterator)
            print('[INFO] type-audio_chunk_iterator: ', type(audio_chunk_iterator))
...
# python3 examples/transcribe_file.py --input-file 1.wav